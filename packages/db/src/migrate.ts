...
const migrations = [
  ...
  { version: '015_add_highlights', file: path.join(schemaDir, '015_add_highlights.sql') },
  { version: '016_add_comment_highlight_id', file: path.join(schemaDir, '016_add_comment_highlight_id.sql') },
  { version: '017_highlight_comment_sync', file: path.join(schemaDir, '017_highlight_comment_sync.sql') }
] as const;
