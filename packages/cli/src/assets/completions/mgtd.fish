...
set -l mgtd_root_commands init memo completion
...
complete -c mgtd -n '__fish_use_subcommand' -a 'completion' -d 'Generate shell completion scripts'

# completion command
complete -c mgtd -n '__fish_seen_subcommand_from completion' -l shell -d 'Target shell' -a 'bash zsh fish'
complete -c mgtd -n '__fish_seen_subcommand_from completion' -l target -d 'Write output to file' -r
complete -c mgtd -n '__fish_seen_subcommand_from completion' -l print-path -d 'Print default script path'
complete -c mgtd -n '__fish_seen_subcommand_from completion' -s h -l help -d 'Show help'
