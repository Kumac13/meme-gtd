...
export default function MemosList() {
  ...
  useEffect(() => {
    ...
    fetchMemos();
  }, [filters.searchQuery, currentPage, bookmarkFilter, selectedLabels, createdFrom, createdTo]);
  ...
  }, [bookmarkFilter, filters.parsedQuery.freeText, selectedLabels, isFetchingOlder, memos.length, total, createdFrom, createdTo]);
